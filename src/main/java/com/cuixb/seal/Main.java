package com.cuixb.seal;


import com.cuixb.seal.configuration.SealCircle;
import com.cuixb.seal.configuration.SealConfiguration;
import com.cuixb.seal.configuration.SealFont;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //1.生成公章
        try {
            SealUtil.buildAndStoreSeal(configuration, "C:\\Users\\xinbin.a.cui\\Desktop\\公章.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "C:\\Users\\xinbin.a.cui\\Desktop\\私章.png");
    }
